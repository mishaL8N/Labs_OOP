...
public class AboutPrimitives {
    ...
    @Koan
    public void wholeNumbersAreOfTypeLong() { assertEquals(getType(10), int.class); }

    @Koan
    public void wholeNumbersAreOfTypeDouble() { assertEquals(getType(33.333), double.class); }
    @Koan
